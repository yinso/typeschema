...
var ScalarTypeTransformer = /** @class */ (function () {
    function ScalarTypeTransformer(className, _v, innerType) {
    ...
    ScalarTypeTransformer.prototype._validate = function () {
        return ast.methodDecl(ast.identifier('validate'), 'public', 'class', 'readonly', [
            ...
            ast.ifExp(ast.binaryExp('==', ast.funcallExp(ast.identifier('typeof'), [this.arg]), ast.stringExp(this.innerType.name)), ast.funcallExp(ast.memberExp(ast.identifier('err'), ast.identifier('push')), [
                ast.objectExp([
...
var StringTypeTransformer = /** @class */ (function () {
    function StringTypeTransformer(inner) {
        this._inner = inner;
    }
    StringTypeTransformer.prototype.transform = function () {
        var transformer = new ScalarTypeTransformer(this._inner.name, ast.identifier('_v'), ast.scalarTypeExp('string'));
        return transformer.transform();
    };
    return StringTypeTransformer;
}());
exports.StringTypeTransformer = StringTypeTransformer;
