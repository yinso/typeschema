...
var ItemsConstraint = (function () {
    ...
    ItemsConstraint.prototype.jsonify = function (value) {
        return value;
    };
...
var ArraySchema = (function (_super) {
    ...
    function ArraySchema(options) {
        ...
        _this = _super.call(this, 'array', constraints, options.$make ? options.$make : undefined) || this;
        if (options.items)
            _this.items = options.items;
        return _this;
    }
    ArraySchema.prototype.jsonify = function (value) {
        var _this = this;
        if (S.TypeMap.array.isa(value) || value instanceof Array) {
            return value.map(function (item) { return _this.items.jsonify(item); });
        }
        else {
