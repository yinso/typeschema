...
var StringSchema = (function (_super) {
    ...
    function StringSchema(options) {
        ...
        _this = _super.call(this, 'string', constraints, options.$make ? options.$make : (options.format ? formatMap[options.format.format].make : undefined)) || this;
        return _this;
    }
    return StringSchema;
}(S.TypeSchema));
...
var formatMap = {
    'date-time': {
        isa: valiDate,
        make: function (value) { return new Date(value); }
    }
};
