...
var BooleanSchema = (function (_super) {
    ...
    function BooleanSchema(options) {
        ...
        _this = _super.call(this, 'boolean', constraints, options.$make ? options.$make : undefined) || this;
        return _this;
    }
    BooleanSchema.prototype.jsonify = function (value) {
        if (value instanceof Boolean) {
            return value.valueOf();
        }
        else {
            var schema = S.getSchema(value.constructor);
            if (schema === this) {
                return value.valueOf();
            }
            else {
