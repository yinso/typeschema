...
var TypeScriptPrinter = /** @class */ (function () {
    ...
    TypeScriptPrinter.prototype._class = function (node) {
        var _this = this;
    ...
    TypeScriptPrinter.prototype._classProperty = function (node) {
    ...
    TypeScriptPrinter.prototype._methodParamList = function (paramlist) {
        var _this = this;
    ...
    TypeScriptPrinter.prototype._visibility = function (visibility) {
    ...
    TypeScriptPrinter.prototype._typeDecl = function (node) {
        return pretty_printer_1.concat(pretty_printer_1.flexWS(), pretty_printer_1.text(':'), this._node(node));
    };
    TypeScriptPrinter.prototype._scalarType = function (node) {
    ...
    TypeScriptPrinter.prototype._refType = function (node) {
    ...
    TypeScriptPrinter.prototype._objectKV = function (node, i) {
        if (i === void 0) { i = 0; }
    ...
    TypeScriptPrinter.prototype._object = function (node) {
        var _this = this;
    ...
    TypeScriptPrinter.prototype._return = function (node) {
    ...
    TypeScriptPrinter.prototype._unary = function (node) {
    ...
    TypeScriptPrinter.prototype._new = function (node) {
        var _this = this;
        var params = [];
        node.paramList.forEach(function (param, i) {
            if (i > 0) {
    ...
    TypeScriptPrinter.prototype._throw = function (node) {
