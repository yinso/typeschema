...
function stringTypeExp(args) {
    if (args === void 0) { args = {}; }
    return __assign({ type: 'StringTypeExp' }, args);
}
...
function patternConstraint(pattern, flags) {
    if (flags === void 0) { flags = ''; }
    return { type: 'PatternConstraint', pattern: pattern, flags: flags };
}
exports.patternConstraint = patternConstraint;
function isPatternConstraint(arg) {
    return !!arg && arg.type === 'PatternConstraint' && util_1.isString(arg.pattern) && util_1.isString(arg.flags);
}
exports.isPatternConstraint = isPatternConstraint;
...
function isMinLengthConstraint(arg) {
    return !!arg && arg.type === 'MinLengthConstraint' && util_1.isNumber(arg.minLength) && util_1.isBoolean(arg.inclusive);
}
exports.isMinLengthConstraint = isMinLengthConstraint;
...
function isMaxLengthConstraint(arg) {
    return !!arg && arg.type === 'MaxLengthConstraint' && util_1.isNumber(arg.maxLength) && util_1.isBoolean(arg.inclusive);
}
exports.isMaxLengthConstraint = isMaxLengthConstraint;
function isConstraint(arg) {
...
var Environment = /** @class */ (function () {
    ...
    Environment.prototype.del = function (key) {
...
function defineTypeExp(name, typeValue) {
    return { type: 'DefineTypeExp', name: name, typeValue: typeValue };
}
exports.defineTypeExp = defineTypeExp;
function isDefineTypeExp(arg) {
    return !!arg && arg.type === 'DefineTypeExp' && isIdentifier(arg.name) && isTypeExp(arg.typeValue);
}
exports.isDefineTypeExp = isDefineTypeExp;
