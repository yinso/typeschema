...
var RequiredConstraint = (function () {
    ...
    RequiredConstraint.prototype.jsonify = function (value) {
        return value;
    };
...
var PropertiesConstraint = (function () {
    ...
    PropertiesConstraint.prototype.jsonify = function (value) {
...
var ObjectSchema = (function (_super) {
    ...
    function ObjectSchema(options) {
        ...
        _this = _super.call(this, 'object', constraints, options.$make ? options.$make : undefined) || this;
    ...
    ObjectSchema.prototype.jsonify = function (value) {
